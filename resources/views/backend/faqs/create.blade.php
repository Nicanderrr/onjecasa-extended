...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Add a frequently asked question to help your customers</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.faqs.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="question" class="form-control" value="{{ old('question') }}" placeholder="Enter the question" required>
                @error('question')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="answer" class="form-control" placeholder="Enter the answer" required>{{ old('answer') }}</textarea>
                @error('answer')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
