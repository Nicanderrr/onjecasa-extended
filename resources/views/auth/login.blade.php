      ...
      <div class="auth-layout">
        ...
        <div class="auth-content">
          <form id="loginForm" class="auth-form-wrap" method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-3">
              <label class="auth-label" for="email">Email / Cashier Username</label>
              <div class="input-group input-group-alternative">
                <span class="input-group-text"><i class="bi bi-person-badge"></i></span>
                <input id="email" class="form-control" type="text" name="email" value="{{ old('email') }}" placeholder="admin@mail.com or cashier" required autofocus autocomplete="username">
              </div>
            </div>
